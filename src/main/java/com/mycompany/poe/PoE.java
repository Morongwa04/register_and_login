...
public class PoE {
    ...
    private static void RegistrationAndLogin() {
        ...
        String username;
        while (true) {
            username = JOptionPane.showInputDialog("Please enter your username (must contain '_' and be ≤5 characters)");
            ...
            JOptionPane.showMessageDialog(null, "Username must contain '_' and be ≤5 characters. Try again.");
        }
       
        // Phone number
        String phoneNumber;
        while (true) {
            phoneNumber = JOptionPane.showInputDialog("Enter your South African phone number (format: +27XXXXXXXXX or 0XXXXXXXXX)");
        ...
        String password;
        while (true) {
            password = JOptionPane.showInputDialog("Enter a password (≥8 chars, with uppercase, number, and special char)");
    ...
    private static void sendMessages() {
        ...
        try {
            ...
            for (int i = 0; i < messageCount; i++) {
                ...
                String[] actions = {"Send Message", "Store Message", "Discard Message"};
    ...
    private static void runAdvancedMessageManagementSystem() {
        ...
        while (running) {
            String[] options = {
                "Add Message", "Full Report", "Disregarded Messages", 
                "Stored Messages", "Delete by Hash", "Senders/Recipients", 
                "Longest Message", "Search by ID", "Search by Recipient", "Back"
            };
